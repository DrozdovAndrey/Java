...
//         Worker3 w1 = new Worker3("Name", "FamilyName", 20, 201);
////         Worker3 w2 = w1;// new Worker3("Имя", "Фамилия", 20, 201); - это одно и то же
//        Worker3 w2 = new Worker3("Name", "FamilyName", 20, 201);
//
//
//         System.out.println(w1 == w2);
//         System.out.println(w1.equals(w2));
